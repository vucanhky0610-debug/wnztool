...
-- =============================================================================
-- [★] MODULE TÍCH HỢP V5 (MỞ RỘNG TỪ V4 - KHÔNG THAY ĐỔI CORE)
-- =============================================================================

-- 1. Thêm danh mục mới vào UI
local ExtraSub = CreateCategory("⚙️ ADVANCED TOOLS")

-- 2. Thêm tính năng vào danh mục
CreateToggle(ExtraSub, "Infinite Jump", false, function(state)
...
CreateToggle(ExtraSub, "Fullbright", false, function(state)
...
CreateToggle(ExtraSub, "Load DarkDex", false, function(state)
    if state then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/infyproceed/DEX/master/main.lua"))()
    end
end)

-- 3. Anti-AFK (Chạy ngầm không cần toggle)
